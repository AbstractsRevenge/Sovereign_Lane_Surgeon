...
- **One SoC generation proven.** `preflight` (above) is the offline half; the images of felix (gs101) and oriole (zuma) get the same measurement as cheetah when their builds finish.
